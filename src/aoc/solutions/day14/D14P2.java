...
public class D14P2 {
    ...
    public static void run() {
        ...
        System.out.println(simulate(blockedPoints, maxY + 2));

    }

    private static int simulate(Set<Point> blocked, int floor) {
        ...
        while(true) {
            ...
            sandCount++;
            if(blocked.contains(currSandPos)) break;
